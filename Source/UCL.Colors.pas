...
var
  ...
  // Round Const
  ROUND_MAX_CONST: integer;
  ROUND_MIN_CONST: integer;
  ROUND_TINY_CONST: integer;
...
initialization
  ...
  FORM_FONT_SIZE := 10;
  FORM_BACK := TUThemeColorSet.Create(0, 15987699, 2171169);
  //  Popup menu
  ...
  //  Caption bar
  CAPTIONBAR_BACK := TUThemeColorSet.Create(15987699, 15987699, 2171169);
  //  Button
  ...
  SLIDER_BACK.SetLightColor($999999, $999999, $999999, $999999, $999999, $999999);
  SLIDER_BACK.SetDarkColor($666666, $666666, $666666, $666666, $666666, $666666);
  SLIDER_CURSOR := TUStateColorSet.Create;
  SLIDER_CURSOR.SetLightColor($D77800, $171717, $CCCCCC, $D77800, $171717, $CCCCCC);
  SLIDER_CURSOR.SetDarkColor($767676, $F2F2F2, $767676, $D77800, $F2F2F2, 4276545);
  //  Hyperlink
  ...
  //  Edit
  EDIT_BACK := TUThemeColorSet.Create($FFFFFF, $FFFFFF, $0F0F0F);
